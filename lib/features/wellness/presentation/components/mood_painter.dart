...
class MoodPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = isSelected ? Colors.pink[300]!.withOpacity(0.8) : Colors.grey[400]!.withOpacity(0.8)
    ...
    switch (mood) {
      case 0: // Very sad
        ...
        canvas.drawArc(
          Rect.fromCenter(center: center, width: size.width - 4, height: size.height - 4),
        ...
        // Sad eyes (teardrops)
        _drawTeardropEye(canvas, Offset(size.width / 2 - 6, size.height / 2 - 8), paint, fillPaint);
        _drawTeardropEye(canvas, Offset(size.width / 2 + 6, size.height / 2 - 8), paint, fillPaint);
        break;
      ...
      case 1: // Sad
        ...
        canvas.drawArc(
          Rect.fromCenter(center: center, width: size.width - 4, height: size.height - 8),
          0.1,
          math.pi * 0.9,
          false,
          paint,
        ...
        _drawDownturnedEye(canvas, Offset(size.width / 2 - 6, size.height / 2 - 8), paint);
        _drawDownturnedEye(canvas, Offset(size.width / 2 + 6, size.height / 2 - 8), paint);
        break;
      ...
      case 2: // Neutral
        ...
        // Neutral eyes
        _drawNeutralEye(canvas, Offset(size.width / 2 - 6, size.height / 2 - 8), paint, fillPaint);
        _drawNeutralEye(canvas, Offset(size.width / 2 + 6, size.height / 2 - 8), paint, fillPaint);
        break;
      ...
      case 3: // Happy
        ...
        _drawHappyEye(canvas, Offset(size.width / 2 - 6, size.height / 2 - 8), paint);
        _drawHappyEye(canvas, Offset(size.width / 2 + 6, size.height / 2 - 8), paint);
        break;
      ...
      case 4: // Very happy
        ...
        canvas.drawArc(
          Rect.fromCenter(center: center, width: size.width - 2, height: size.height - 6),
          0,
          math.pi,
          false,
          paint,
        ...
        _drawVeryHappyEye(canvas, Offset(size.width / 2 - 6, size.height / 2 - 8), paint);
        _drawVeryHappyEye(canvas, Offset(size.width / 2 + 6, size.height / 2 - 8), paint);
        ...
        if (isSelected) {
          final cheekPaint = Paint()
            ...
            ..style = PaintingStyle.fill;
          canvas.drawCircle(Offset(size.width / 2 - 8, size.height / 2), 2, cheekPaint);
          canvas.drawCircle(Offset(size.width / 2 + 8, size.height / 2), 2, cheekPaint);
        }
        break;
    }
  ...
  void _drawTeardropEye(Canvas canvas, Offset center, Paint paint, Paint fillPaint) {
    final path = Path()
  ...
  void _drawNeutralEye(Canvas canvas, Offset center, Paint paint, Paint fillPaint) {
